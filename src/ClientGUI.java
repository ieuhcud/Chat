...
public class ClientGUI extends JFrame {
    ...
    public JLabel getLblIp() {
        if (lblIp == null) {
            lblIp = new JLabel("IP ");
            lblIp.setFont(new Font("Arial Unicode MS", Font.BOLD, 21));
    ...
    public JLabel getLblPort() {
        if (lblPort == null) {
            ...
            lblPort.setFont(new Font("Arial Unicode MS", Font.BOLD, 21));
    ...
    public JButton getBtnNewButton() {
        if (btnNewButton == null) {
            ...
            btnNewButton.setFont(new Font("Arial Unicode MS", Font.BOLD, 20));
    ...
    public JLabel getLblNewLabel_1() {
        if (lblNewLabel_1 == null) {
            ...
            lblNewLabel_1.setFont(new Font("Arial Unicode MS", Font.PLAIN, 18));
        }
